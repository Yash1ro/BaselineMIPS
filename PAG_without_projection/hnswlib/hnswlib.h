...
namespace hnswlib {
    ...
    public:
        ...
        virtual void searchKnn(float *, float *, float *, size_t, std::vector<Neighbor>&, float*, int, std::vector<Node>&)const = 0;

        virtual void buildTable(std::vector<std::vector<float>>&, std::vector<std::vector<float>> &, std::vector<Node>&)=0;
